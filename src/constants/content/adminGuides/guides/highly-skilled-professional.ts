...
const highlySkilledProfessional: AdminGuide = {
    ...
    icon: 'star',
    color: '#D4AC0D',
    description: 'Tư cách lưu trú 高度専門職 dùng hệ thống tính điểm — người đủ 70 điểm thường được ưu đãi vượt trội so với visa lao động thông thường (thời hạn 5 năm, rút ngắn điều kiện 永住). Nhiều người Việt làm IT, nghiên cứu hoặc quản lý có thể đủ điều kiện mà không biết. Kết quả thực tế còn phụ thuộc hồ sơ và xét duyệt của 出入国在留管理庁 — nên xác nhận quy định mới nhất trước khi nộp.',
    searchKeywords: [
      'visa cao cap',
      'visa cao do',
      'highly skilled',
    ...
    counterPhrases: [
      {
        jp: 'ポイント計算表を作成してきました。確認していただけますか。',
        romaji: 'Pointo keisanhyou o sakusei shite kimashita. Kakunin shite itadakemasu ka.',
        vn: 'Tôi đã chuẩn bị sẵn bảng tính điểm. Anh/chị xem giúp được không?',
        note: 'Mở đầu khi gặp 出入国在留管理庁. Lịch sự nhưng cho thấy bạn đã chuẩn bị.',
      },
      {
        jp: '現在「技術・人文知識・国際業務」ですが、高度専門職1号ロへ変更したいです。',
        romaji: 'Genzai gijutsu jinbun chishiki kokusai gyoumu desu ga, koudo senmonshoku 1-gou ro e henkou shitai desu.',
        vn: 'Hiện tôi đang visa 技人国, muốn đổi sang 高度専門職1号ロ.',
        note: 'Nói rõ tư cách hiện tại + đích đến. ロ là nhóm IT/kỹ thuật phổ biến nhất với người Việt.',
      },
      {
        jp: 'ベトナムの大学の卒業証明書は日本語訳と公証付きで用意しました。',
        romaji: 'Betonamu no daigaku no sotsugyou shoumeisho wa nihongo-yaku to koushou-tsuki de youi shimashita.',
        vn: 'Bằng đại học Việt Nam tôi đã chuẩn bị kèm bản dịch tiếng Nhật và công chứng.',
        note: 'Bằng VN cần dịch công chứng — không tự dịch. Báo trước để tránh bị bổ sung sau.',
      },
      {
        jp: '在留期間を最長の5年に更新したいですが、可能でしょうか。',
        romaji: 'Zairyuu kikan o saichou no 5-nen ni koushin shitai desu ga, kanou deshou ka.',
        vn: 'Tôi muốn gia hạn thời hạn lưu trú lên tối đa 5 năm, có được không ạ?',
        note: '高度専門職1号 thường được cấp 5 năm — nhưng kết quả thực tế do 出入国在留管理庁 quyết định.',
      },
      {
        jp: '配偶者の就労についても確認したいです。',
        romaji: 'Haiguusha no shuurou ni tsuite mo kakunin shitai desu.',
        vn: 'Tôi cũng muốn xác nhận về việc đi làm của vợ/chồng.',
        note: '高度専門職 thường cho phép vợ/chồng làm fulltime không giới hạn — khác visa thường.',
      },
      {
        jp: '高度専門職2号への変更条件を教えてください。',
        romaji: 'Koudo senmonshoku 2-gou e no henkou jouken o oshiete kudasai.',
        vn: 'Anh/chị cho tôi biết điều kiện đổi sang 高度専門職2号.',
        note: '2号 thường yêu cầu đã hoạt động 3 năm ở 1号 + duy trì điểm — nên xác nhận lại tại Nyukan vì có thể thay đổi.',
      },
    ],
    keyTerms: [
      {
        term: '高度専門職1号',
        reading: 'こうどせんもんしょく1ごう',
        meaningVi: 'visa Lao động Trình độ Cao loại 1 (3 nhóm: イ/ロ/ハ)',
        noteVi: 'Tư cách lưu trú thời hạn 5 năm. 3 nhóm: 1号イ (nghiên cứu/giảng dạy), 1号ロ (kỹ thuật/IT — phổ biến nhất với người Việt), 1号ハ (quản lý/kinh doanh). Cần đạt 70 điểm trở lên theo bảng tính của 出入国在留管理庁.',
      },
      {
        term: '高度専門職2号',
        reading: 'こうどせんもんしょく2ごう',
        meaningVi: 'visa Lao động Trình độ Cao loại 2 (thời hạn không giới hạn)',
        noteVi: 'Bước nâng cấp sau khi giữ 高度専門職1号 thường khoảng 3 năm + duy trì điểm. Thời hạn không giới hạn (vô thời hạn) nhưng KHÔNG phải 永住 — vẫn là 在留資格 và cần hồ sơ xét. Phạm vi hoạt động rộng hơn 1号.',
      },
      {
        term: 'ポイント計算表',
        reading: 'ポイントけいさんひょう',
        meaningVi: 'bảng tính điểm hệ thống visa cao cấp',
        noteVi: 'Form tính điểm chính thức của 出入国在留管理庁. Cộng theo bằng cấp (cử nhân 10 / thạc sĩ 20 / tiến sĩ 30), thu nhập năm (tối đa 40), tuổi, JLPT (N1 = 15, N2 = 10), kinh nghiệm, thành tích. Chỉ cộng điểm khi có tài liệu chứng minh — tự khai sai = hồ sơ có thể bị từ chối.',
      },
      {
        term: '永住申請の優遇措置',
        reading: 'えいじゅうしんせいのゆうぐうそち',
        meaningVi: 'ưu đãi rút ngắn thời gian xin vĩnh trú',
        noteVi: '70 điểm + giữ tư cách lưu trú liên tục thường được phép xin 永住 sau 3 năm; 80 điểm sau 1 năm (so với 10 năm thông thường). Vẫn phải đáp ứng các điều kiện 永住 khác (thuế, bảo hiểm, hành vi đúng pháp luật) — không tự động.',
      },
      {
        term: '配偶者の就労',
        reading: 'はいぐうしゃのしゅうろう',
        meaningVi: 'quyền làm việc của vợ/chồng',
        noteVi: 'Vợ/chồng của 高度専門職 thường được phép làm fulltime không giới hạn 28 giờ/tuần — khác hẳn 家族滞在 thông thường (giới hạn 28h). Vẫn cần đăng ký với 出入国在留管理庁.',
      },
      {
        term: '親の帯同',
        reading: 'おやのたいどう',
        meaningVi: 'mang cha/mẹ sang ở cùng',
        noteVi: 'Đặc quyền hẹp — thường yêu cầu cả hai vợ chồng đi làm + có con dưới 7 tuổi (hoặc đang mang thai), thu nhập hộ gia đình trên ngưỡng (~800 vạn yên/năm). Điều kiện có thể khác theo Nyukan + đang được điều chỉnh — nên xác nhận thông tin mới nhất.',
      },
      {
        term: '家事使用人',
        reading: 'かじしようにん',
        meaningVi: 'người giúp việc gia đình',
        noteVi: '高度専門職 có thể bảo lãnh giúp việc trong điều kiện nghiêm ngặt (thu nhập cao + đặc thù gia đình). Hiếm dùng — không phải mọi 高度専門職 đều đủ điều kiện.',
      },
      {
        term: '在留資格変更許可申請',
        reading: 'ざいりゅうしかくへんこうきょかしんせい',
        meaningVi: 'đơn xin đổi tư cách lưu trú',
        noteVi: 'Form cần nộp khi đang ở Nhật + muốn chuyển sang 高度専門職. Khác 認定証明書交付申請 (dành cho người xin từ ngoài Nhật). Trong thời gian xét, tư cách cũ vẫn có giá trị.',
      },
    ],
    officialLinks: [
