...
const residenceCard: AdminGuide = {
    ...
    icon: 'card',
    color: '#185FA5',
    description: 'Thủ tục gia hạn visa (chính thức là 在留期間更新許可申請) — xin tiếp tục ở Nhật với cùng tư cách lưu trú hiện tại. Khác với gia hạn hiệu lực vật lý của 在留カード.',
    searchKeywords: [
      'gia hạn visa',
      'visa hết hạn',
      'visa sắp hết hạn',
