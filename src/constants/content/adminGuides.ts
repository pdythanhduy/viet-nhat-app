...
export const ADMIN_GUIDES: AdminGuide[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      {
        step: 4,
        title: 'Điền và kiểm tra tờ khai',
        description: 'Quy trình trên 確定申告書等作成コーナー:\n\n1. Chọn loại thu nhập (給与所得、事業所得、雑所得 v.v.).\n2. Nhập số từ 源泉徴収票 vào các ô tương ứng — hệ thống tự tính.\n3. Khai các khoản khấu trừ (các phần deduction):\n   - 医療費控除: nhập tổng chi phí y tế và thu nhập.\n   - 住宅ローン控除: nhập số dư vay cuối năm và diện tích nhà.\n   - 寄附金控除 (ふるさと納税): nhập từng khoản.\n4. Hệ thống tính ra số thuế còn phải nộp thêm hoặc số tiền hoàn lại.\n5. Nhập thông tin tài khoản ngân hàng để nhận hoàn thuế.\n6. Xem lại toàn bộ trước khi nộp.',
        documents: [],
