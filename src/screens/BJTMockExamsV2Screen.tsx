...
const styles = StyleSheet.create({
  ...
  statLabel: { fontSize: 11, fontWeight: '700', color: Colors.textSecondary, marginBottom: 6 },
  ...
  summaryScore: { marginTop: 6, fontSize: 28, fontWeight: '800', color: Colors.textPrimary },
  summaryPercent: { marginTop: 6, fontSize: 22, fontWeight: '800', color: Colors.primaryDark },
  ...
  examTitle: { fontSize: 15, fontWeight: '800', color: Colors.textPrimary },
  examMeta: { fontSize: 11, fontWeight: '700', color: Colors.textMuted },
  ...
  examHistory: { marginTop: 8, fontSize: 12, fontWeight: '700', color: Colors.primaryDark },
  primaryButton: {
    marginTop: 4,
    flexDirection: 'row',
    alignItems: 'center',
  ...
  badge: { flex: 1, fontSize: 12, fontWeight: '700', color: Colors.primaryDark },
  timerCard: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 6,
  ...
  blockTitle: { marginBottom: 8, fontSize: 11, fontWeight: '800', color: Colors.textMuted, textTransform: 'uppercase' },
  promptJp: { fontSize: 13, lineHeight: 20, color: Colors.textPrimary },
  questionJp: { fontSize: 14, lineHeight: 20, color: Colors.textPrimary, fontWeight: '700' },
  optionRow: {
    flexDirection: 'row',
    alignItems: 'flex-start',
    gap: 10,
  ...
  optionLabel: { width: 24, fontSize: 13, fontWeight: '800', color: Colors.textPrimary },
  ...
  flex: { flex: 1 },
  explanationTitle: { fontSize: 13, fontWeight: '800', color: Colors.textPrimary },
  ...
  reviewMeta: { fontSize: 11, fontWeight: '700', color: Colors.textMuted },
