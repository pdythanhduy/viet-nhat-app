...
const styles = StyleSheet.create({
  ...
  modeChipText: { fontSize: 13, fontWeight: '800', fontFamily: 'BeVietnamPro_800ExtraBold', color: Colors.textPrimary },
  ...
  scriptBadge: { fontSize: 13, fontWeight: '700', fontFamily: 'BeVietnamPro_700Bold' },
  questionCard: {
    marginTop: 16,
    backgroundColor: Colors.white,
    borderRadius: 18,
  ...
  promptLabel: { fontSize: 13, fontWeight: '700', fontFamily: 'BeVietnamPro_700Bold', color: Colors.textSecondary, marginBottom: 12 },
  kana: { fontSize: 64, fontWeight: '800', fontFamily: 'BeVietnamPro_800ExtraBold', color: Colors.textPrimary, marginTop: 12 },
  ...
  optionText: { fontSize: 16, fontWeight: '700', fontFamily: 'BeVietnamPro_700Bold', color: Colors.textPrimary },
  summaryCard: {
    flex: 1,
    marginTop: 12,
    backgroundColor: Colors.white,
  ...
  summaryLabel: { fontSize: 14, fontWeight: '700', fontFamily: 'BeVietnamPro_700Bold', color: Colors.textSecondary },
  summaryScore: { fontSize: 38, fontWeight: '800', fontFamily: 'BeVietnamPro_800ExtraBold', marginTop: 12 },
  ...
  primaryButtonText: { color: Colors.white, fontWeight: '800', fontFamily: 'BeVietnamPro_800ExtraBold' },
  secondaryButton: {
    marginTop: 12,
    borderRadius: 14,
