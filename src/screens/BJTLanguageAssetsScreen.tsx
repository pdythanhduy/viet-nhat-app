...
const styles = StyleSheet.create({
  ...
  tabText: { fontSize: 12, fontWeight: '800', color: Colors.textPrimary, textTransform: 'capitalize' },
  ...
  kanji: { fontSize: 34, fontWeight: '800', color: Colors.textPrimary },
  meaning: { fontSize: 14, fontWeight: '700', color: Colors.primary },
  meta: { fontSize: 12, color: Colors.textSecondary, lineHeight: 18 },
  blockTitle: { marginTop: 10, marginBottom: 6, fontSize: 11, fontWeight: '800', color: Colors.textMuted, textTransform: 'uppercase' },
  ...
  pattern: { fontSize: 18, fontWeight: '800', color: Colors.textPrimary },
  ...
  jp: { fontSize: 13, color: Colors.textPrimary, lineHeight: 20, fontWeight: '700' },
});
