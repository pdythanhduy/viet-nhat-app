...
const styles = StyleSheet.create({
  ...
  level: { fontSize: 13, fontWeight: '700', fontFamily: 'BeVietnamPro_700Bold' },
  ...
  label: { fontSize: 12, fontWeight: '700', fontFamily: 'BeVietnamPro_700Bold', color: Colors.primary, marginBottom: 12 },
  jp: { fontSize: 28, fontWeight: '800', fontFamily: 'BeVietnamPro_800ExtraBold', color: Colors.textPrimary, textAlign: 'center' },
  romaji: { marginTop: 8, fontSize: 14, color: Colors.textMuted, fontStyle: 'italic', textAlign: 'center' },
  meaning: { fontSize: 24, fontWeight: '700', fontFamily: 'BeVietnamPro_700Bold', color: Colors.textPrimary, textAlign: 'center' },
  ...
  answerText: { fontSize: 14, fontWeight: '700', fontFamily: 'BeVietnamPro_700Bold' },
  summary: { flex: 1, alignItems: 'center', justifyContent: 'center' },
  title: { fontSize: 22, fontWeight: '800', fontFamily: 'BeVietnamPro_800ExtraBold', color: Colors.textPrimary },
  subtitle: { marginTop: 8, fontSize: 14, color: Colors.textSecondary },
  percent: { marginTop: 12, fontSize: 32, fontWeight: '800', fontFamily: 'BeVietnamPro_800ExtraBold' },
  ...
  statNum: { fontSize: 22, fontWeight: '800', fontFamily: 'BeVietnamPro_800ExtraBold', color: Colors.textPrimary },
