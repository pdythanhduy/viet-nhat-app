...
const styles = StyleSheet.create({
  ...
  titleVi: { marginTop: 4, fontSize: 17, fontWeight: '800', color: Colors.textPrimary },
  ...
  speaker: { fontSize: 11, fontWeight: '800', color: Colors.textMuted, textTransform: 'uppercase', marginBottom: 4 },
  jp: { fontSize: 14, fontWeight: '700', color: Colors.textPrimary, lineHeight: 20 },
