...
const styles = StyleSheet.create({
  ...
  countText: { fontSize: 12, fontWeight: '700', fontFamily: 'BeVietnamPro_700Bold', color: Colors.primary },
  ...
  word: { fontSize: 20, fontWeight: '800', fontFamily: 'BeVietnamPro_800ExtraBold', color: Colors.textPrimary },
  reading: { marginTop: 3, fontSize: 12, color: Colors.textSecondary },
  meaning: { marginTop: 6, fontSize: 14, fontWeight: '700', fontFamily: 'BeVietnamPro_700Bold', color: Colors.primary },
  themeBadge: {
    borderRadius: 999,
  ...
  themeBadgeText: { fontSize: 10, fontWeight: '700', fontFamily: 'BeVietnamPro_700Bold', color: Colors.textMuted },
  chevron: { marginTop: 4 },
  exampleBox: {
    marginTop: 12,
    paddingTop: 12,
  ...
  exampleJp: { fontSize: 13, fontWeight: '700', fontFamily: 'BeVietnamPro_700Bold', color: Colors.textPrimary, lineHeight: 20 },
