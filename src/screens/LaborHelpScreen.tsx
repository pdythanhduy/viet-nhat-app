...
const styles = StyleSheet.create({
  ...
  urgencyText: { fontSize: 10, fontWeight: '800', fontFamily: 'BeVietnamPro_800ExtraBold' },
  urgencyTextHigh: { color: Colors.danger },
  urgencyTextMedium: { color: Colors.warning },
  cardTitle: { fontSize: 15, fontWeight: '800', fontFamily: 'BeVietnamPro_800ExtraBold', color: Colors.textPrimary },
  ...
  copyScenarioText: { fontSize: 12, fontWeight: '700', fontFamily: 'BeVietnamPro_700Bold', color: Colors.primary },
  section: { marginTop: 8 },
  sectionTitle: { fontSize: 12, fontWeight: '800', fontFamily: 'BeVietnamPro_800ExtraBold', color: Colors.textPrimary, marginBottom: 8 },
  ...
  resetButtonText: { fontSize: 12, fontWeight: '700', fontFamily: 'BeVietnamPro_700Bold', color: Colors.primary },
