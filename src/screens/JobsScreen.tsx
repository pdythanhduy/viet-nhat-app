...
const styles = StyleSheet.create({
  ...
  workerFilterText: { fontSize: 12, fontWeight: '700', fontFamily: 'BeVietnamPro_700Bold', color: Colors.textSecondary },
  ...
  profileText: { flex: 1 },
  profileTitle: { fontSize: 15, fontWeight: '800', fontFamily: 'BeVietnamPro_800ExtraBold', color: Colors.textPrimary, marginBottom: 6 },
  ...
  noticeBold: { fontWeight: '700', fontFamily: 'BeVietnamPro_700Bold', color: Colors.textPrimary },
  sectionTitle: {
    fontSize: 17,
    fontWeight: '800', fontFamily: 'BeVietnamPro_800ExtraBold',
    color: Colors.textPrimary,
  ...
  updateText: { flex: 1 },
  updateTitle: { fontSize: 13, fontWeight: '800', fontFamily: 'BeVietnamPro_800ExtraBold', color: Colors.textPrimary, marginBottom: 4 },
  ...
  categoryTitle: { flex: 1, fontSize: 14, fontWeight: '700', fontFamily: 'BeVietnamPro_700Bold', color: Colors.textPrimary },
  countChip: {
    minWidth: 24,
    paddingHorizontal: 6,
    paddingVertical: 4,
  ...
  countChipText: { fontSize: 11, fontWeight: '700', fontFamily: 'BeVietnamPro_700Bold', color: Colors.primary },
  ...
  platformName: { fontSize: 14, fontWeight: '800', fontFamily: 'BeVietnamPro_800ExtraBold', color: Colors.textPrimary },
  ...
  openBtnText: { fontSize: 12, fontWeight: '700', fontFamily: 'BeVietnamPro_700Bold', color: Colors.white },
  ...
  targetTagText: { fontSize: 11, fontWeight: '700', fontFamily: 'BeVietnamPro_700Bold' },
  tag: {
    paddingHorizontal: 10,
    paddingVertical: 6,
    borderRadius: 999,
  ...
  tagText: { fontSize: 11, color: Colors.textSecondary, fontWeight: '600', fontFamily: 'BeVietnamPro_600SemiBold' },
  rightsCard: {
    backgroundColor: Colors.white,
    borderRadius: 14,
    overflow: 'hidden',
  ...
  rightInfo: { flex: 1 },
  rightTitle: { fontSize: 13, fontWeight: '700', fontFamily: 'BeVietnamPro_700Bold', color: Colors.textPrimary, marginBottom: 4 },
  ...
  guideText: { flex: 1 },
  guideTitle: { fontSize: 13, fontWeight: '800', fontFamily: 'BeVietnamPro_800ExtraBold', color: Colors.textPrimary, marginBottom: 3 },
  ...
  lawLinkText: { flex: 1 },
  lawLinkTitle: { fontSize: 13, fontWeight: '700', fontFamily: 'BeVietnamPro_700Bold', color: Colors.primary, marginBottom: 3 },
